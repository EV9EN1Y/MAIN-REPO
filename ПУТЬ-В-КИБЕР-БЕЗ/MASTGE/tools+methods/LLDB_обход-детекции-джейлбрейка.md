...
чтобы максимально усложнить жизнь взломщику - то можно было бы сделать так защиту:
...
10 - отправлять сводку о взломе на сервер

и потом, чтобы разобраться в этой суете - потребуется много времени и сил...
