...
## признаки Java-сериализации `  ¬í   `

вот эта хрень   ` ¬í  ¬í  ¬í  ¬í  ¬í   `это символ `aced 0005`
омпьютер видит байты `0xac 0xed 0x00 0x05`, а текстовый редактор показывает их как символы `¬í`

==Это  100%  признаки Java-сериализации==
 
 Это имена Java-классов  accessTokent Ljava/lang/String;L usernameq ~ xpt
 Их наличие — второй верный признак что есть JAVA сериализация


доп признаки (на будущее)
здесь их нет
JSP, JSF, Spring
