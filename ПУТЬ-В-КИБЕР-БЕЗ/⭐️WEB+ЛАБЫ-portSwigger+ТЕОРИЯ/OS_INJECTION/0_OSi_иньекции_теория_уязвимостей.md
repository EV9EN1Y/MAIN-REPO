...
Следующие разделители команд работают только на системах на базе Unix:

- `;`
- Newline (`0x0a` или `\n`)

На системах на базе Unix также можно использовать обратные тики или символ доллара для выполнения встроенной команды внутри оригинальной команды:

- `` ` ``инжекционная команда `` ` ``
- `$(`инжекционная команда `)`
...
# как не допустить такую уязвимость?
