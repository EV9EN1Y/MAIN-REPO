...
пробую! отправил в чат скрипт этот, что кнопку нажимает!
вау!   XSS сработала и удалила нах мой аккаунт!

Снимок14.01.59AILLM8
...
Почему сработало в  примере с SVg? Потому что разработчики библиотеки Svg.Skia использовали стандартный парсер XML, который был опасным из-за версии или настроек, и не отключили обработку внешних сущностей. А код приложения просто доверился библиотеке.