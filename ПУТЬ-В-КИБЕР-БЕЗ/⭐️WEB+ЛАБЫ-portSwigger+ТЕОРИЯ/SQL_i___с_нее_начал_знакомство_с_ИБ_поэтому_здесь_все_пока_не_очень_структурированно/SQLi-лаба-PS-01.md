...
скачал сертификат для бурп  http://burp, потом скачал мозилу, так как у нее есть возможность добавлять сертификат только к ней, а не во всю операц систему
...
обрезал часть запроса, и бд выдала все, че есть у нее
