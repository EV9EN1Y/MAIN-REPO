...
# Лаборатория: Кража токенов доступа OAuth через открытое перенаправление
...
ПОЭТОМУ НА МОЙ ХОСТ ПРИЙДЕТ ПРОСТО ОТВЕТ НО БЕЗ ТОКЕНА!
...
и открыл этот поддельный запрос!
и получил в ответе преход на свою страницу
