...
---
заметил что если подбирать пароли при входе в аккаунт - то ожидание/блок после 1й неудачной попытки = 1 минута
...
пробовал менять токены разными способами, но результат не меняется, такое ощущение будто токен живет сколько то времени, но ошибки о просроченном токене не приходят! по прежнему ответ 302
