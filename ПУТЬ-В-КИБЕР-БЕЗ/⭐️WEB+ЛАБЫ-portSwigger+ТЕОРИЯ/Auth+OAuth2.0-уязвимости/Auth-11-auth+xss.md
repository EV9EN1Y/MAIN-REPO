...
значит попробую сам найти xss, хотя я про xss подробно не учил до этих пор.
...
--------
```html
<script>alert(111)</script> создал такой простой скрипт! 
...
я взял данные карлоса и вошел в его аакаунт, затем я на своем сервере увидел его пароль и логин защифрованно, 
